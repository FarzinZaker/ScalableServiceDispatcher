    ...
    var $window = $(window),
        ...
        _setInlineErrorMessage = function ($input, mess, conf, $messageContainer) {
            ...
            if (custom) {
                ...
                var $mess = $input.parent().parent().find('.help').find('.' + conf.errorMessageClass + '.help-block');
                if ($mess.length == 0) {
    ...
    $.formUtils = {
        ...
        defaultConfig: function () {
            return {
                ...
                borderColorOnError: '#bc3100', // Border color of elements which value is invalid, empty string to not change border color
        ...
        LANG: {
            ...
            requiredFields: 'لطفاً مقدار این فیلد را وارد نمایید.',
            badTime: 'You have not given a correct time',
            badEmail: 'آدرس پست الکترونیک وارد شده صحیح نمی باشد.',
            badTelephone: 'شماره تلفن وارد شده صحیح نمی باشد.',
            ...
            notConfirmed: 'رمز عبورهای وارد شده مطابقت ندارند.',
            badDomain: 'آدرس وب سایت وارد شده اشتباه است.',
            badUrl: 'آدرس اینترنتی وارد شده صحیح نمی باشد.',
